...
print("\n\n\n Answer: White standard errors are slightly larger for intercept, educ, age, and age2. They are slightly smaller for female and white. The white test shows evidence of heteroskedasticity. The p-value of the f-statistic of the hypothesis that the error variance does not depend on x is .0004.\n\n\n")
...
print("\n\n\n Answer: SE is bigger on educ because the intracluster correlations are positive. Without accounting for clustering, we effectively overestimate our sample size.\n\n\n")
...
print("The expected value of our estimator will be biased downwards (1-(d/(1-r))) where d is the noise to total variance ratio (var of measurement error / var of observed lwages) and r is the r-squared value from our regression of the the X's on observed lwage.\n\n\n")
