...
"""
# This function will find mean diff for smokers / non smokers in given df
def do_a(df, variable):
    ...
    for i in range(len(df.columns)):
        ...
        t = ttest_ind(df_noSmoke[var], df_smoke[var])
        ts.append(t)
...
print("Note: I originally wrote a function to find the optimal p-score groups. After testing, however, it looks like using a simple decision tree learner gives results that are just as good. \n\n\n") 
...
# Trimming off outliers (top and bottom .05)
def trim(df, amount):
...
print("Repeating a) for young women \n\n\n")
# parts a, b
do_a(df_young, 'dbirwt')

print("Repeating b) for young women \n\n\n")
do_b(df_young, 'dbirwt')

print("Repeating e) for young women \n\n\n")
# part e)
print("\n\n\n Using propensity score as control in original regression. \n\n\n")
print(lm_p.summary()) # model built in part e), just printing summary here
print(compare_pg(df_y))

print("Repeating f) for young women \n\n\n")
# part f)
do_f(df_y)

print("Repeating g) for young women \n\n\n")
# part g)
do_g(df_y)

print("Repeating i) for young women \n\n\n")
# part i)
# finding simple diff in means in effect of smoking on death
do_a(df_y, 'death')
# running ols, effect of smoking on death
